        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="foto_kepsek img-fluid position-absolute w-100 h-100"
                        src="{{ asset ('storage/'.$k->foto) }}" alt="" style="object-fit: cover; border-radius: 25px">
                </div>
            </div>
                ...
                <div class="testimonial-text">
                    <div class="short-message">
                        ...
                        <p class="mb-4">Mari bergabung bersama kami dalam perjalanan pendidikan yang penuh makna dan
                            ...
                            berdaya saing tinggi. <span class="text-primary"><b>Read More...</b></span></p>
                    </div>
